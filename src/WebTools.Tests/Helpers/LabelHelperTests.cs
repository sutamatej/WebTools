...
namespace WebTools.Tests.Helpers
{
    public class LabelHelperTests
    {
        ...
        public void Label_helper_renders_html()
        {
            ...
            var result = helper.Label(m => m.SomeProperty, "a label").ToString();
        ...
        public void Label_helper_renders_class_attribute()
        {
            ...
            var result = helper.Label(m => m.SomeProperty, "label").Class("test-class").ToString();
        ...
        public void Label_helper_renders_id_attribute()
        {
            ...
            var result = helper.Label(m => m.SomeProperty, "test").Id("test-id").ToString();
        ...
        public void Label_helper_supports_attribute_combinations()
        {
            ...
            var result = helper.Label(m => m.SomeProperty, "more testing").Id("test-id").Class("test-class").ToString();
